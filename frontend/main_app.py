...
def main():
    ...
    # Footer แบบข้อความธรรมดา
    st.write("---")
    st.write("🙏 **ขอบคุณคณะกรรมการจาก สำนักงานส่งเสริมเศรษฐกิจดิจิทัล (depa)**")
    st.write("ที่มอบโอกาสอันทรงคุณค่าให้กับทีม **Taxes1112 – วิทยาลัยเทคนิคสัตหีบ**")
    st.write("ในการเข้าร่วมโครงการและนำเสนอผลงานด้าน **นวัตกรรมดิจิทัล**")
    st.write("")
    st.write("ℹ️ **คำเตือน:**")
    st.write("• ระบบนี้ใช้ AI เพื่อช่วยจำแนกประเภทพระเครื่อง")
    st.write("• ผลลัพธ์เป็นข้อมูลประกอบการตัดสินใจเท่านั้น")
    st.write("• ระบบไม่ได้ระบุว่าเป็นพระแท้หรือพระเก๊")
